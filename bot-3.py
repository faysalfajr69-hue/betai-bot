...
AI_SYSTEM_PROMPT = (
    ...
    "6) Sana verilen veriler eksik veya belirsizse, Google araması yaparak güncel/doğru bilgiyi bulmaya çalış "
    "(sakatlık, kadro, son dakika haberleri gibi). Bulduğun bilginin kaynağını kısaca belirt."
)
